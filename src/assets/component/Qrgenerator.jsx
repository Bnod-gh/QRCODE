...
function Qrgenerator({ data }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-neutral-500 w-auto h-full">
      <div className="flex flex-col mt-2 ml-2 flex-wrap w-[210mm] h-[297mm] pt-[10mm] bg-slate-800 text-white ">
